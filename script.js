...
class Street extends Element {
    ...
    classifyStreet() {
        ...
        console.log(`${this.name}, build in ${this.buidYear} is a ${classification.get(this.size)} street.`);
    }
}
...
function calc(arr) {
    ...
    return [sum, sum / arr.length]; // Use descrtuctoring on array
}
...
function reportStreet(s) {
    ...
    ${totalLength} km, with an average length of ${avgLength}`)
